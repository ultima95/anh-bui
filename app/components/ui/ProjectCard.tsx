...
export default function ProjectCard({ project }: { project: ProjectRow }) {
  return (
    <article className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 ring-1 ring-black/[0.07]">
      {/* Image */}
