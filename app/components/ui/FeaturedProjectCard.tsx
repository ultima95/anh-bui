...
export default function FeaturedProjectCard({ project }: { project: ProjectRow }) {
  return (
    <article className="group grid md:grid-cols-[1.1fr_1fr] gap-0 bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 ring-1 ring-black/[0.07]">
